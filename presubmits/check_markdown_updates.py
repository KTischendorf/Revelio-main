...
If a markdown file has not been updated in the past 3 months, a warning message
...
FRESHNESS = datetime.now() - timedelta(days=90)
WARNING_MESSAGE = """!!! danger "Trust but verify"
This document has not been updated in the past 3 months. The information contained
within may be stale. Proceed with healthy skepticism.\n"""
